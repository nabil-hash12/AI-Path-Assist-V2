        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="md:w-1/2 bg-surface-container p-6 rounded-xl border border-surface-container-highest">
            ...
            <form className="flex flex-col gap-4">
              <div className="flex gap-4">
                <input className="w-full bg-surface-container-lowest border border-outline-variant rounded-md px-4 py-2 text-sm text-on-surface placeholder:text-outline focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="First Name" type="text" />
                <input className="w-full bg-surface-container-lowest border border-outline-variant rounded-md px-4 py-2 text-sm text-on-surface placeholder:text-outline focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="Last Name" type="text" />
              </div>
              <input className="w-full bg-surface-container-lowest border border-outline-variant rounded-md px-4 py-2 text-sm text-on-surface placeholder:text-outline focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" placeholder="Institutional Email" type="email" />
              <button className="w-full bg-primary text-on-primary rounded-md px-4 py-2 text-sm font-bold mt-2 hover:bg-primary-fixed transition-colors" type="button">
                Submit Request
              </button>
            </form>
          </div>
