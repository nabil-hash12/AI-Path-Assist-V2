      ...
      <div className="h-screen flex flex-col overflow-hidden">
        <header className="bg-surface/80 backdrop-blur-md sticky top-0 z-40 border-b border-outline-variant flex justify-between items-center w-full px-margin h-16 flex-shrink-0">
          <div className="flex items-center gap-md">
            <button onClick={() => router.push("/analysis")} className="text-on-surface-variant hover:text-on-surface">
        ...
        <main className="flex-grow flex overflow-hidden relative">
          ...
          <aside className="w-80 bg-surface-container-lowest border-l border-outline-variant flex flex-col h-full flex-shrink-0 z-20 overflow-y-auto">
