        ...
        <div className="max-w-[800px] mx-auto flex flex-col gap-lg">
          ...
          <section className="bg-surface-container-lowest border border-surface-container-highest rounded-xl p-lg flex flex-col gap-md">
            ...
            <div className="flex flex-col gap-1 text-sm">
              <span className="text-on-surface-variant">Email: <span className="font-data-mono text-on-surface">support@ai-path-assist.example</span></span>
              <span className="text-on-surface-variant">On-call line: <span className="font-data-mono text-on-surface">+880 (0) 1XXX-XXXXXX</span></span>
            </div>
          </section>
        </div>
      </main>
