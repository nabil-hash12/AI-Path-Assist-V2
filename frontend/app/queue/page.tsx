              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="font-body-md">
                    {activeJobs.length === 0 && (
                      <tr>
                        <td colSpan={5} className="p-md text-center text-on-surface-variant text-sm">No active jobs. Upload a slide to start AI inference.</td>
                      </tr>
                    )}
                    {activeJobs.map((job) => (
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-lg">
            ...
            <section className="bg-surface-container-lowest border border-surface-container-highest rounded-lg flex flex-col flex-grow">
              ...
              <ul className="flex flex-col max-h-[400px] overflow-y-auto">
                {history.length === 0 && (
                  <li className="p-md text-center text-on-surface-variant text-sm">No completed jobs yet.</li>
                )}
                {history.map((h) => (
